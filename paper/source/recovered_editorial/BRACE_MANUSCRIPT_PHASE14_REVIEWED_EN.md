...
The study uses the cited SEISMIC and DeepHawkes Weibo releases. Protocols, analysis code, aggregate results and reporting checks are retained with the study materials; full model and score archives are identified in the supplement. The Weibo release specifies research use and citation of its authors. **Author completion required before submission:** provide the durable code/artifact URL and data-access conditions consistent with the source terms. No public deposit or blanket redistribution license is asserted here.
